...
CREATE TEMP TABLE unit4_recovery_state (instance_id TEXT);
INSERT INTO unit4_recovery_state
SELECT df.start('SELECT 404 AS recovered', 'unit4-clean-recovery');
...
BEGIN
    SELECT instance_id INTO recovered_id FROM unit4_recovery_state;
