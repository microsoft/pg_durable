...
CREATE TABLE _duroxide.unit4_provider_sentinel (
    marker TEXT PRIMARY KEY
);
INSERT INTO _duroxide.unit4_provider_sentinel VALUES ('must-survive-rejection');

INSERT INTO df.instances (id, label, root_node, status, submitted_by, database)
VALUES
    ('a0000001', 'unit4-signal-target', 'b0000001', 'running', CURRENT_USER::pg_catalog.regrole, CURRENT_DATABASE()),
    ('a0000002', 'unit4-cancel-target', 'b0000002', 'running', CURRENT_USER::pg_catalog.regrole, CURRENT_DATABASE()),
    ('a0000003', 'unit4-monitor-target', 'b0000003', 'completed', CURRENT_USER::pg_catalog.regrole, CURRENT_DATABASE());
