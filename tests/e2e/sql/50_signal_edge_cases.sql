...
CREATE TEMP TABLE _b12b_state AS
SELECT df.start('SELECT 1', 'test-signal-after-complete') AS instance_id;
...
DECLARE
    ...
    status TEXT;
BEGIN
    SELECT instance_id INTO inst_id FROM _b12b_state;
