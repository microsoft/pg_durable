...
pub async fn execute_subtree(
    ...
    let vars_json = input["vars"].as_str().unwrap_or("{}");
    ...
    // Create execution context with vars passed from parent
...
async fn execute_loop_node(
    ...
    let new_input = FunctionInput {
        ...
        local_vars: HashMap::new(), // Not preserved across continue_as_new
        global_vars: HashMap::new(), // Not preserved across continue_as_new
    };
